...
DEFAULT_PORT_FRONTEND_LOGIN=30092
...
PORT_FRONTEND_LOGIN=${PORT_FRONTEND_LOGIN:-${DEFAULT_PORT_FRONTEND_LOGIN}}
...
sed -i "s/:${DEFAULT_PORT_FRONTEND_LOGIN}/:${PORT_FRONTEND_LOGIN}/g" ${TARGET_FILE}
