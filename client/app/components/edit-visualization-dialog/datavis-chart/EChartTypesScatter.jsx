...
class EChartTypesScatter extends React.Component {
  constructor(props) {
    super(props);
...
EChartTypesScatter.propTypes = {
  chartType: PropTypes.string,
  serie: PropTypes.string,
  chartTypeCb: PropTypes.func.isRequired
};

EChartTypesScatter.defaultProps = {
  chartType: '',
  serie: ''
};
...
export default function init(ngModule) {
  ngModule.component(
    'eChartTypesScatter',
    react2angular(EChartTypesScatter, Object.keys(EChartTypesScatter.propTypes), [
      '$rootScope',
      '$scope'
    ])
  );
