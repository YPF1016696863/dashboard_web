  ...
  return {
    ...
    link($scope, element, attr, ctrl) {
      Cesium.Ion.defaultAccessToken =
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiJkMTI1MDExMy1iMDk3LTRkYTEtYmUxOS0yYWNhYmViOTYxOWMiLCJpZCI6MTI5ODAsInNjb3BlcyI6WyJhc3IiLCJnYyJdLCJpYXQiOjE1NjIyNzg1NTR9.oG3ePuTVVEJEVQfTjvFKqMFeuU72E0dN_q3jTJWhsmY';

      ctrl.cesium = new Cesium.Viewer('cesiumContainer', {
      ...
      const startingLocation = {
        centerLong: (108.92861 * Math.PI) / 180,
        centerLat: (34.25833 * Math.PI) / 180
      };
...
export default function init(ngModule) {
  ...
  ngModule.config(VisualizationProvider => {
    ...
    const editoTemplate = '<cesium-editor></cesium-editor>';
